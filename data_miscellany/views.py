...
class DataMiscellanyHomeView(TemplateView):
    template_name = 'data_miscellany_home.html'


class VizUSBirthsView(TemplateView):
    template_name = 'viz_us_births.html'
...
def BookListFictionView(request):
    ...
    return render(
        request, 'fiction_list.html', {'top_list': top_list, 'list_date': nyt_list_date}
    )
